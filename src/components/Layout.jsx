...
const icons = {
  ...
  HandCoins: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
      ...
      <path d="M7 21l1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2L21 12a2 2 0 00-2.8-2.8L16 11.5"/>
      <path d="M2 16l6 6"/>
      <circle cx="16" cy="6" r="3"/>
      <path d="M16 3v1M16 8v1M13.5 4.5l.7.7M18.5 7.5l.7.7M13.5 7.5l.7-.7M18.5 4.5l.7-.7"/>
    </svg>
  ),
};
