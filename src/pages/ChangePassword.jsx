  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (err && typeof err === 'object') {
        ...
        if (Object.keys(fieldMap).length) { setFieldErrors(fieldMap); return; }
      }
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleChange} autoComplete={auto}
            placeholder="••••••••••"
          ...
          <div className="px-10 pb-10" style={{ paddingTop: '80px' }}>
            ...
            {success && (
              <div className="mb-5 px-4 py-3 rounded-xl bg-emerald-500/15 border border-emerald-400/35 flex items-center gap-2.5">
                ...
                <p className="text-emerald-200 text-sm">Password changed successfully</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {loading ? (
                  ...
                  <><LockIcon /><span>Set New Password</span></>
                )}
              </button>
            </form>
